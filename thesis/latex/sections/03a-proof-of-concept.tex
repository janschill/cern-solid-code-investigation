...
Every container and resource in Solid is protected with \glspl{acl}, which determine if specific agents, groups, or the world can have read, write, append, or control access. 
