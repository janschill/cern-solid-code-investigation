...
To evaluate the security of the chosen architecture of the system it make sense to look a the \texttt{auth} package and those modules interfacing user input into the system. The user input modules can be found in the \texttt{component} package.
