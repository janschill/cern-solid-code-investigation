...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{prototype/poc-solid-comment-description.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{prototype/poc-solid-comment-agenda.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1\textwidth]{prototype/poc-solid-comment-comments.png}
