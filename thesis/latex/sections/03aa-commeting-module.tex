...
\begin{itemize}
    ...
    \item \textbf{Valid level values}: 1, 2, 3, 4, 5
\end{itemize}
...
\begin{enumerate}
    \item An adversary posts a comment with a string containing an attack for \gls{xss}
...
\begin{table}[h!]
    ...
    \label{table:poc1-evaluation-auth}
\end{table}
