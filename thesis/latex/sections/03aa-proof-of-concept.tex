...
product cycles where the balance between new feature development and maintainability 

new features are named and decided on

The \textbf{internal developer} is responsible for the application (Indico) and all its quality attributes. They develop new features
