...
Open-source by the community owned software brings a lot of advantage, but also needs to be tread lightly, because it always relies on independent developers to fix bugs, develop features, which 
\vspace{0.5cm}
