...
% Introduce sectioning below paragraph 
\titleclass{\subsubparagraph}{straight}[\paragraph]
\newcounter{subsubparagraph}
\renewcommand{\thesubsubparagraph}{\Alph{subsubparagraph}}
\titleformat{\subsubparagraph}[runin]{\normalfont\normalsize\itshape}{\thesubsubparagraph}{1em}{}
\titlespacing*{\subsubparagraph} {}{3.25ex plus 1ex minus .2ex}{1em}

\usepackage{thesis/latex/minted}

% colors for code snippets
% ss\definecolor{commentscolor}{rgb}{0.5,0.5,0.5}
